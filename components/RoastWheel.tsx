...
export default function RoastWheel({
  ...
  return (
    <figure className="chart-explorer my-12 md:my-16">
      <div className="natal-wheel-scope relative border border-ash/10 bg-void p-4 md:p-8">
        ...
        <p className="chart-hint">ASTRO ROASTS / YOUR COSMIC PAPERWORK</p>
        <h2 className="chart-heading">Same you. Two perspectives.</h2>
        ...
        <div
          ...
          onTouchStart={(e) => {
            if ((e.target as Element).closest("[data-chart-zoomed=true]")) {
              start.current = null;
              return;
            }
              ...
              {partner && (
                <label className="chart-controls">
                  ...
                  >
                    ...
                    <option value={1}>{names?.[1] || partner.name}</option>
                  </select>
                </label>
              )}
              <HumanDesignChart
              ...
              <div className="chart-layout">
                ...
                <aside className="chart-reader">
                  ...
                  <div className="chart-placements">
                    {elements
                      .filter((e) => e.kind === "planet" || e.kind === "angle")
                      .map((e) => (
                        <button
                          key={e.id}
                          className="chart-row"
                  ...
                  <p className="chart-hint">
                    Select a placement here or on the chart. Its exact position
                    stays attached to the explanation.
                  </p>
